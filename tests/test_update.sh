...
mkdir -p "$cat/lib" "$cat/agents/upd/claude"
cp -r "$ROOT/lib/." "$cat/lib/"
printf 'v1\n' >"$cat/agents/upd/claude/a.md"
...
# bump para 2.0.0 com novo conteudo
printf 'v2\n' >"$cat/agents/upd/claude/a.md"
...
assert_eq v2 "$(cat "$proj/.claude/agents/a.md")" "arquivo atualizado para v2"
